            ...
            <div class="col-lg-10 col-12">
                <div class="pricing-content-wrap bg-custom-light rounded-custom shadow-lg">
                    ...
                    <div class="price-feature-col pricing-action-info p-5 right-radius bg-light order-0 order-lg-1">
                        ...
                        <form class="mt-5 register-form" id="formSubmition">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" placeholder="Password" id="password" name="password" required aria-label="Password">
                                    </div>
                                </div>
                                <div class="col-12">
...
<script>
    ...
    $("#formSubmition").submit(function(e) {
        e.preventDefault();
        let method = "POST";
        let action = "{{ route('register') }}";
        let form = $('#formSubmition');
        let formData = new FormData();
        let formDataArray = form.serializeArray();
        for (let i = 0; i < formDataArray.length; i++) {

            let formDataItem = formDataArray[i];
            var formDataItemVal = formDataItem.value;
            formData.append(formDataItem.name, formDataItemVal);
        }
        $.ajax({
            url: action,
            method: method,
